            ...
            <form onSubmit={handleSubmit} className="space-y-4 flex-1 overflow-y-auto">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-neutral-300 rounded bg-white focus:ring-2 focus:ring-[#E91E63] focus:border-[#E91E63] outline-none mb-2"
                />
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {featuredProducts.map((productId) => {
                    ...
                    return (
                      <div
                        key={productId}
                        className="flex items-center gap-1 bg-[#E91E63]/10 text-[#E91E63] px-2 py-1 rounded text-sm"
                      >
              ...
              <div className="flex gap-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 bg-[#E91E63] text-white px-4 py-2 rounded hover:bg-[#D81B60] disabled:opacity-50"
                >
