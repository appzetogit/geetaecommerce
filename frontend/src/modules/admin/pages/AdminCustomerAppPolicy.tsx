...
export default function AdminCustomerAppPolicy() {
  const [policyContent, setPolicyContent] = useState(`Welcome to Geeta Stores - 10 Minute App!
      ...
      <div className="bg-white px-4 sm:px-6 py-4 border-b border-neutral-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="text-sm text-neutral-600">
            <span className="text-[#E91E63]">Home</span> / <span className="text-neutral-900">Customer App Policy</span>
          </div>
        </div>
      </div>
