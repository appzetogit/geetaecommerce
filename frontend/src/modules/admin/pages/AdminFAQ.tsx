            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={submitting}
                  className="w-full bg-[#f187b5] hover:bg-[#e076a5] disabled:bg-neutral-400 disabled:cursor-not-allowed text-white px-4 py-2 rounded font-medium transition-colors flex items-center justify-center">
                  {submitting ? (
                    <>
                        ...
                        <td className="p-4 align-middle border border-neutral-200">
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              disabled={submitting}
                              className="p-1.5 bg-[#f187b5] hover:bg-[#e076a5] disabled:bg-neutral-400 disabled:cursor-not-allowed text-white rounded transition-colors"
                              title="Edit">
                              <svg
                                width="14"
                                height="14"
