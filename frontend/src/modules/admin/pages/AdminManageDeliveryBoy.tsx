                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 border border-neutral-300 rounded text-sm bg-white focus:ring-1 focus:ring-[#f187b5] focus:outline-none"
                                >
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    type="text"
                                    className="px-3 py-2 border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[#f187b5] focus:outline-none min-w-[200px]"
                                    value={searchTerm}
                                    onChange={(e) => {
                            ...
                            {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 border border-[#f187b5] rounded font-medium text-sm ${currentPage === pageNum
