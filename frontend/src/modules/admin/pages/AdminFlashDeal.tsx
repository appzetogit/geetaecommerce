          ...
          <div className="lg:col-span-1 space-y-6">
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6">
                <h2 className="text-lg font-bold mb-6 flex items-center gap-2">
                    <span className="w-8 h-8 rounded-lg bg-[#f187b5]/10 text-[#f187b5] flex items-center justify-center">⚙️</span>
                    General Settings
                </h2>

                    <label className="flex items-center gap-3 mb-6 p-4 bg-[#f187b5]/5 border border-[#f187b5]/20 rounded-xl cursor-pointer hover:bg-[#f187b5]/10 transition-colors">
                    <input
                        type="checkbox"
                        className="w-5 h-5 accent-[#f187b5]"
                ...
                <div className="space-y-4 mb-6">
                    <label className="block">
                        ...
                        <input
                            type="date"
                            className="w-full border border-gray-200 rounded-xl p-3 focus:ring-2 focus:ring-[#f187b5]/20 focus:border-[#f187b5] outline-none transition-all font-medium"
                ...
                <button
                    onClick={handleSave}
                    disabled={loading}
                    className="w-full bg-[#f187b5] text-white p-4 rounded-xl font-black uppercase tracking-widest text-xs hover:bg-[#e076a5] disabled:opacity-70 shadow-lg shadow-pink-200 transition-all active:scale-[0.98]"
                >
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6 flex flex-col h-[700px]">
                <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
                    <span className="w-8 h-8 rounded-lg bg-[#f187b5]/10 text-[#f187b5] flex items-center justify-center">📦</span>
                    Product Library
                </h2>
                <div className="relative mb-4">
                     <input
                        ...
                        className="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-3 outline-none focus:ring-2 focus:ring-[#f187b5]/10 focus:border-[#f187b5] transition-all"
                        value={search}
                        ...
                        products.map(p => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`p-3 border-b border-neutral-50 flex items-center gap-3 cursor-pointer transition-all ${isSelected ? 'bg-neutral-50 opacity-40 cursor-not-allowed' : 'hover:bg-[#f187b5]/5'}`}
                                >
                                    ...
                                    <button
                                        className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${isSelected ? 'bg-neutral-200 text-white' : 'bg-[#f187b5] text-white shadow-md shadow-pink-100 hover:scale-110 active:scale-90'}`}
                                    >
                                 ...
                                 <div key={(p._id || p.id) + index} className="bg-white p-3 rounded-2xl shadow-sm border border-neutral-100 flex items-center gap-4 group relative">
                                      ...
                                      <div className="flex-1 min-w-0">
                                          ...
                                          <div className="flex items-center gap-2 mt-1">
                                              <p className="text-[#f187b5] font-black text-sm">₹{(p as any).salePrice || p.price}</p>
