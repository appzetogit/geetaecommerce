...
const AdminOutOfStockSummary = () => {
  ...
  const [filteredData, setFilteredData] = useState<OutOfStockData[]>([]);
  ...
  // Dummy data for demonstration - Only OUT OF STOCK items (quantity = 0)
  useEffect(() => {
    const dummyData: OutOfStockData[] = [
      {
        _id: "1",
        name: "L'OREAL PARIS HYALURON SHAMPOO",
        variantName: "-",
        uom: "Piece",
        purchaseValue: 165,
        mrp: 210,
      ...
      {
        _id: "4",
        name: "SHUBH ANNAPRASHAN RICE 220",
        variantName: "-",
        uom: "Piece",
        purchaseValue: 0,
        mrp: 220,
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gradient-to-r from-red-50 to-red-100 border-b-2 border-red-200">
                  ...
                  <th className="px-3 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider sticky left-0 bg-red-50 z-10">Name</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredData.length === 0 ? (
                  <tr>
                    <td colSpan={editMode ? 11 : 10} className="px-6 py-12 text-center text-gray-400 text-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            ...
            <p className="text-3xl font-black text-orange-600 mt-2">
              ₹{filteredData.reduce((sum, item) => sum + (item.sellingPrice * 10), 0).toLocaleString()}
            </p>
          </div>
