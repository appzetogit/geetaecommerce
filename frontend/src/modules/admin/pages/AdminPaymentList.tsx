    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {loading && (
        <div className="flex items-center justify-center py-12">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#f187b5] mr-2"></div>
              ...
              <div className="p-4 sm:p-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-neutral-300 rounded text-sm bg-neutral-50 text-neutral-700 focus:outline-none focus:ring-2 focus:ring-[#f187b5] focus:border-[#f187b5] disabled:bg-neutral-100 disabled:cursor-not-allowed"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    disabled={updating === method._id}
                    className="w-full px-4 py-2.5 border border-neutral-300 rounded text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#f187b5] focus:border-[#f187b5] disabled:bg-neutral-100 disabled:cursor-not-allowed">
                ...
                <button
                  ...
                  disabled={updating === method._id}
                  className="w-full bg-[#f187b5] hover:bg-[#e076a5] disabled:bg-neutral-400 disabled:cursor-not-allowed text-white px-4 py-2.5 rounded text-sm font-medium transition-colors flex items-center justify-center">
                  {updating === method._id ? (
                    <>
