...
export default function AdminSellerLocation() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Approved':
        return 'bg-[#f187b5]/10 text-[#f187b5]';
      case 'Pending':
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        ...
        <div className="text-sm text-neutral-600">
          <span className="text-[#f187b5] hover:text-[#e076a5] cursor-pointer">Home</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#f187b5] focus:border-[#f187b5]"
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
          ...
          {selectedSeller && (
            <div className="p-4 sm:p-6 border-t border-neutral-200 bg-[#f187b5]/5">
                ...
                {filteredSellers.map((seller) => (
                  <div
                    ...
                    className={`p-4 cursor-pointer transition-colors ${selectedSeller?._id === seller._id
                      ? 'bg-[#f187b5]/5 border-l-4 border-[#f187b5]'
                      : 'hover:bg-neutral-50'
                      }`}
                  >
