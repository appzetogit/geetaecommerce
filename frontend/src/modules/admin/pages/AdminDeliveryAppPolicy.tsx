...
export default function AdminDeliveryAppPolicy() {
  const [policyContent, setPolicyContent] = useState(`Welcome to Geeta Stores - 10 Minute App Delivery Partner Program!
      ...
      <div className="bg-white px-4 sm:px-6 py-4 border-b border-neutral-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="text-sm text-neutral-600">
            <span className="text-[#E91E63]">Home</span> / <span className="text-neutral-900">Delivery App Policy</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 sm:p-6">
                <div>
                  ...
                  <textarea
                    ...
                    rows={25}
                    required
                    className="w-full px-4 py-3 border border-neutral-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-[#E91E63] focus:border-[#E91E63] resize-y font-mono"
                  />
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                type="submit"
                className="bg-[#E91E63] hover:bg-[#D81B60] text-white px-8 py-2.5 rounded-lg text-base font-medium transition-colors"
              >
                Update Policy
              </button>
            </div>
