       ...
       <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/3">
             <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                <div className="bg-[#f187b5] text-white px-4 py-3 font-semibold text-lg flex justify-between items-center">
                   {editingBannerId ? 'Edit Banner' : 'Add Banner'}
                   {editingBannerId && (
                       <button onClick={handleCancelEdit} className="text-xs bg-white text-[#f187b5] px-2 py-1 rounded hover:bg-gray-100">Cancel</button>
                   )}
                </div>
                <div className="p-6 space-y-5">
                   ...
                   <div>
                      ...
                      <select
                        className="w-full border border-gray-300 rounded-md p-2.5 outline-none focus:ring-1 focus:ring-[#f187b5] bg-white"
                        value={bannerType}
                   ...
                   <button
                      ...
                      disabled={loading}
                      className={`w-full bg-[#f187b5] hover:bg-[#e076a5] text-white font-medium py-2.5 rounded-md transition-colors shadow-sm mt-2 flex justify-center items-center ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                   >
                      {loading ? (
                          <>
             ...
             <div className="bg-white rounded-lg shadow-sm overflow-hidden h-full flex flex-col">
                                 ...
                                 <tr key={banner.id} className="hover:bg-gray-50 group">
                                    ...
                                    <td className="px-6 py-4">
                                       <div className="flex flex-col">
                                           ...
                                           <span className="text-[10px] bg-[#f187b5]/10 text-[#f187b5] px-1.5 py-0.5 rounded w-fit mt-1">
                                    ...
                                    <td className="px-6 py-4">
                                       <div className="flex items-center gap-2">
                                           <button
                                              ...
                                              className="p-1.5 bg-[#f187b5] text-white rounded shadow-sm hover:opacity-90"
                                           >
                ...
                <div className="p-4 border-t text-xs text-gray-500 flex justify-between">
                     ...
                     <div className="flex gap-1">
                         ...
                         <button className="px-2 py-1 border rounded bg-[#f187b5] text-white">1</button>
