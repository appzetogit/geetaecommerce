                    ...
                    <tr
                      ...
                      <td className="p-4 align-middle text-center">
                          <button
                            ...
                            className={`px-3 py-1 rounded-full text-xs font-semibold transition-all hover:scale-105 active:scale-95 ${product.publish ? 'bg-[#f187b5]/10 text-[#f187b5] hover:bg-[#f187b5]/20' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                          >
