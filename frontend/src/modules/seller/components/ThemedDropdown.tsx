              ...
              <div className="px-2 pb-2 pt-1 border-b border-neutral-100 sticky top-0 bg-white z-10">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search..."
                    className="w-full pl-8 pr-3 py-1.5 text-sm bg-neutral-50 border border-neutral-200 rounded-md focus:outline-none focus:border-seller-500 focus:ring-1 focus:ring-seller-500/20"
              ...
              filteredOptions.map((option) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-sm transition-colors duration-150
                    ${option.value === value
                      ? 'bg-seller-50 text-seller-700 font-medium'
