            ...
            <button
                ...
                className={`h-8 w-8 rounded-full flex items-center justify-center text-xs font-medium transition-colors
                    ${isSelected
                        ...
                        : isToday
                            ? 'text-seller-600 font-bold border border-seller-200 bg-seller-50'
    ...
    <div className={`relative ${className}`} ref={containerRef}>
      <button
        ...
        className={`w-full flex items-center justify-between px-3 py-2 bg-white border border-neutral-300 rounded-lg text-sm transition-all duration-200 outline-none
          ${disabled ? 'opacity-50 cursor-not-allowed bg-neutral-50' : 'hover:border-seller-500 focus:ring-2 focus:ring-seller-500/20 active:bg-neutral-50 cursor-pointer'}
          ${isOpen ? 'border-seller-500 ring-2 ring-seller-500/20' : ''}
        `}
      >
        <div className="flex items-center gap-2 truncate">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={`${value ? 'text-seller-600' : 'text-neutral-400'}`}>
          ...
          >
            ...
            <div className="mt-3 pt-3 border-t border-neutral-100 flex justify-between">
                ...
                <button
                    ...
                    className="text-xs font-bold text-seller-600 hover:text-seller-700 transition-colors"
                >
                    Today
                </button>
            </div>
