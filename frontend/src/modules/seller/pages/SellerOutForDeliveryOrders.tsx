...
export default function SellerOutForDeliveryOrders() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Out For Delivery': return 'bg-indigo-100 text-indigo-800 border border-indigo-200';
  ...
  return (
    <motion.div className="space-y-6" initial="hidden" animate="visible" variants={containerVariants}>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden">
        <div className="bg-seller-600 text-white px-4 sm:px-6 py-2 sm:py-3"><h2 className="text-base sm:text-lg font-semibold">View Order List</h2></div>
