      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl h-[90vh] flex flex-col">
        ...
        <div className="px-6 py-4 border-t border-neutral-200 flex justify-end gap-3 bg-neutral-50 rounded-b-lg">
          ...
          <button
            ...
            className={`px-6 py-2 rounded text-white font-medium flex items-center gap-2 ${saving || !editableProducts.some(p => p.isChanged) ? "bg-neutral-400 cursor-not-allowed" : "bg-[#f187b5] hover:bg-[#e076a5] shadow-sm transform hover:-translate-y-0.5 transition-all"}`}
          >
            {saving ? (
              <>
