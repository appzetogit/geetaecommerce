                        ...
                        <div className="flex flex-col sm:flex-row gap-3 flex-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="pl-10 pr-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-seller-500 focus:outline-none w-full sm:w-64"
                                        readOnly
                                    />
                                    <svg
                                        width="16"
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-seller-500 focus:outline-none cursor-pointer"
                                >
                                        ...
                                        <tr key={index} className="hover:bg-neutral-50">
                                            ...
                                            <td className="p-4 border border-neutral-200 text-sm text-neutral-900">
                                                <button
                                                    ...
                                                    className="text-seller-600 hover:text-seller-700 text-xs font-medium transition-colors"
                                                >
                                                    View
                                                </button>
                                            </td>
