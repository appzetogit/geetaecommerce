                      ...
                      <td className="px-3 py-3 bg-red-100">
                        {editMode ? (
                          <input
                            ...
                            className="w-20 px-2 py-1 text-sm border border-gray-200 rounded focus:border-seller-500 focus:ring-1 focus:ring-seller-500 outline-none font-bold text-red-700"
                          />
                        ) : (
