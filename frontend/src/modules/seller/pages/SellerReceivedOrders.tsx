          ...
          <div className="flex flex-col xl:flex-row gap-4 items-end xl:items-center justify-between">
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full xl:w-auto">
              ...
              <div className="w-full md:w-auto self-end">
                <button onClick={handleExport} className="w-full md:w-auto flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all shadow-sm hover:shadow active:scale-95">
                ...
                {paginatedOrders.length === 0 ? (
                  ...
                  paginatedOrders.map((order, index) => (
                    <motion.tr key={order.id} className="hover:bg-teal-50/30 transition-colors group" variants={itemVariants} custom={index}>
                      ...
                      <td className="px-6 py-4"><span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(order.status)}`}><span className="w-1.5 h-1.5 rounded-full mr-1.5 bg-teal-500"></span>{order.status}</span></td>
